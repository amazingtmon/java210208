(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Grid("grd_tree","10","50","460",null,null,"10",null,null,null,null,this);
            obj.set_taborder("1");
            ...
            obj = new Grid("grd_list","10","50","460",null,null,"10",null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_binddataset("ds_explorer");
            obj.set_autofittype("col");
            obj.set_treeusecheckbox("false");
            obj.set_treeinitstatus("expand,null");
            obj.set_positionstep("1");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"80\"/><Column size=\"203\"/><Column size=\"80\"/><Column size=\"80\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"TREE_ID\"/><Cell col=\"1\" text=\"TREE_NM\"/><Cell col=\"2\" text=\"TREE_LEVEL\"/><Cell col=\"3\" text=\"TREE_STATE\"/></Band><Band id=\"body\"><Cell text=\"bind:TREE_ID\"/><Cell col=\"1\" text=\"bind:TREE_NM\"/><Cell col=\"2\" text=\"bind:TREE_LEVEL\"/><Cell col=\"3\" text=\"bind:TREE_STATE\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            // Layout Functions
            //-- Default Layout : this
            obj = new Layout("default","Phone_screen",480,850,this,function(p){});
