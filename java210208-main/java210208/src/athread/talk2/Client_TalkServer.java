...
public class Client_TalkServer extends JFrame implements Runnable {
	
	//사용자가 접속을 해올 때 마다(입장) 새로 객체를 생성해야한다.
	//왜냐하면 서로 다른 사용자이기 때문. 사용자마다 소켓, ois, oos이 다르다.
	Client_TalkServerThread 		tst 		= null;
	//Vector로 선언하지 않는 이유는 다형성을 말하기 위함.
	//입장하는 사용자들의 스레드를 관리하기 위함.
	List<Client_TalkServerThread> 	globalList 	= null;
	List<Room>						room 		= null;
	...
	public static void main(String[] args) {
		Client_TalkServer ts = new Client_TalkServer();
		ts.initDisplay();
