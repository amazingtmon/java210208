...
public class MyCalcEventHandler implements ActionListener {
	...
	public MyCalcEventHandler(JTextField jtf_result, JButton jbt_one, JButton jbt_two, 
			JButton jbt_plus, JButton jbt_equals, JButton jbt_clear) {
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if(obj == jbt_one) {
			jtf_result.setText(jbt_one.getText());
		} 
		else if(obj == jbt_two) {
			jtf_result.setText(jbt_two.getText());
		} 
			...
			String result = MyCalcurate.calcurate(v1, v2, op);//MyCalcurate static method.
