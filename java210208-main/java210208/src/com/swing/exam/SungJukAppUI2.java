...
public class SungJukAppUI2 extends JFrame implements ActionListener {
	//선언부
	JLabel jlb_inwon = 
			new JLabel
	...
	JButton jbtn_getData = new JButton("데이터추가");
 ...
 */
	...
	public void initDisplay(){
		...
		jbtn_getData.addActionListener(this);
	...
	public static void main(String[] args) {
		...
		SungJukAppUI2 sja = new SungJukAppUI2();
		sja.initDisplay();
	}
	@Override
...
/*			dtm.setValueAt(aValue, row, column);
		...
		else if(e.getSource()==jbtn_getData) {
			//샘플 데이터 추가.
			String[][] data = {
					 {"홍길동","80","75","85"}
					,{"이성계","90","85","80"}
