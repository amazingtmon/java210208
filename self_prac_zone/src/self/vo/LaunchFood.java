...
public class LaunchFood extends JFrame{
	
	LaunchFoodEvent lfe = new LaunchFoodEvent(this);
	...
	String[] jbtns_label = {"음식","정답","지우기","종료"};
	...
	public void initDisplay() {
		...
		// 이벤트소스 및 이벤트 핸들러 클래스 매핑 코드
		jbtns[0].addActionListener(lfe);
		jbtns[3].addActionListener(lfe);
